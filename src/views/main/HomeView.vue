<template>
  <div class="view">
    <div class="bot-centered">
      <div class="title">Luwu!</div>
      <div class="desc">
        Another multipurpose bot<br/>
        with tons of cool features!
      </div>
      <img src="images/luwu4.png" alt="Luwu!" class="profile"/>
      <div class="buttons">
        <a href="https://discord.com/oauth2/authorize?client_id=661817513247768588&scope=bot%20applications.commands&permissions=338816087">
...
<style scoped>
  ...
  .nertivia {
    background-color: var(--nertiviblue);
  }
  .readmore {
